                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($category_list as $category) { ?>
                                        <tr>
                                            ...
                                            <td><img src="<?php echo $category['img']; ?>" width="60" height="60" /></td>
                                            <td><?php echo $category['name']; ?></td>
                                            <td>
                                                <a class="btn btn-primary" href="edit.php?category_id=<?php echo $category['id']; ?>">Edit</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-danger" href="delete.php?category_id=<?php echo $category['id']; ?>">Delete</a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
