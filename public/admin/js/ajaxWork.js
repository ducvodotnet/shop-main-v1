...
function addItems(){
    ...
    var p_productscol=$('#p_productscol').val();
    ...
    fd.append('p_description', p_description);
    fd.append('p_productscol', p_productscol);
...
function ordersDelete(id){
    $.ajax({
        url:"./controller/deleteOrdersController.php",
        method:"post",
        data:{record:id},
        success:function(data){
